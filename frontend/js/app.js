...
const elapsed=Date.now()-start;const wait=Math.max(0,600-elapsed);
if(r.ok){const d=await r.json();S.user=d.user;await new Promise(t=>setTimeout(t,wait));showApp()}
